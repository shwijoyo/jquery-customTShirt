(function ($) {
  $.fn.customTShirt = function (options) {
    let settings = $.extend(
      {
        ...
        data: {
          point: 0,
          canvas: [
            { name: "front", data: { version: "5.3.0", objects: [], background: "rgba(255, 255, 255)", backgroundImage: { type: "image", version: "5.3.0", originX: "left", originY: "top", left: 0, top: 0, width: 1000, height: 1000, fill: "rgb(0,0,0)", stroke: null, strokeWidth: 0, strokeDashArray: null, strokeLineCap: "butt", strokeDashOffset: 0, strokeLineJoin: "miter", strokeUniform: false, strokeMiterLimit: 4, scaleX: 1, scaleY: 1, angle: 0, flipX: false, flipY: false, opacity: 1, shadow: null, visible: true, backgroundColor: "", fillRule: "nonzero", paintFirst: "fill", globalCompositeOperation: "source-over", skewX: 0, skewY: 0, cropX: 0, cropY: 0, src: "https://cdn.jsdelivr.net/gh/shwijoyo/jquery-customTShirt@v1.0.0/image/tshirt-front.png", crossOrigin: "anonymous", filters: []}}},
            { name: "back", data: { version: "5.3.0", objects: [], background: "rgba(255, 255, 255)", backgroundImage: { type: "image", version: "5.3.0", originX: "left", originY: "top", left: 0, top: 0, width: 1000, height: 1000, fill: "rgb(0,0,0)", stroke: null, strokeWidth: 0, strokeDashArray: null, strokeLineCap: "butt", strokeDashOffset: 0, strokeLineJoin: "miter", strokeUniform: false, strokeMiterLimit: 4, scaleX: 1, scaleY: 1, angle: 0, flipX: false, flipY: false, opacity: 1, shadow: null, visible: true, backgroundColor: "", fillRule: "nonzero", paintFirst: "fill", globalCompositeOperation: "source-over", skewX: 0, skewY: 0, cropX: 0, cropY: 0, src: "https://cdn.jsdelivr.net/gh/shwijoyo/jquery-customTShirt@v1.0.0/image/tshirt-back.png", crossOrigin: "anonymous", filters: []}}},
          ],
        },
        onSave: (data, canvas) => {
          console.log(data);
    ...
    let element = ()=>{
    	let main = `<div style="width: ${$this.width()}px; height: ${$this.width()}px; position: relative; overflow: hidden"><div style="width: 1000px; height: 1000px; position: absolute; font-size: 1000px; top: ${ Number($this.width() / 1000) <= 1 ? "-" + Number((1 - Number($this.width() / 1000)) / 2) : Number((1 - Number($this.width() / 1000)) / 2) * -1  }em; left: ${Number($this.width() / 1000) <= 1 ? "-" + Number((1 - Number($this.width() / 1000)) / 2) : Number((1 - Number($this.width() / 1000)) / 2) * -1}em; transform: scale(${$this.width() / 1000})"><canvas id="${$this.attr("id")}-canvas" width="1000" height="1000" style="position: absolute;"></canvas></div></div>`;
        let editor = `
 <div class="card">
...
<div class="row align-items-start pb-2">
  ...
  let  renderGlobal = (obj)=>{
        ...
        let gradientItem = ()=>{
           ...
           (Number($this.find(`.cte-ecgradientitem`).val()) == 0  ||  Number($this.find(`.cte-ecgradientitem`).val()) == obj.fill.colorStops.length-1)?$this.find(`.cte-ecgradientoffset`).addClass("d-none"):$this.find(`.cte-ecgradientoffset`).removeClass("d-none");
    ...
    let renderText = (obj)=>{
        ...
        if(obj.path != null){
            ...
            $this.find(`.cte-earcx`).attr({min: `-${obj.path.path[1][5]}`, max: `${obj.path.path[1][5]}`}).removeAttr("disabled").val(obj.path.path[1][2]);
            $this.find(`.cte-earcy`).attr({min: `-${obj.path.path[1][5]}`, max: `${obj.path.path[1][5]}`}).removeAttr("disabled").val(obj.path.path[1][4]);
        	}
    ...
    link.href = URL.createObjectURL(file);
    	...
    	$this.find(".cte-color").on("click", function (){
    	     Coloris({
              format: "rgb",
              closeButton: true,
              closeLabel: 'OK',
      ...
      // edit action text
     $this.find(`.cte-efontfamily`).googlefontpicker({onPick: (fontName)=>{
     	obj = canvas.getActiveObject();
      ...
      $this.find(`.cte-efontweight`).on("click", ()=>{
        ...
        $this.find(`.cte-efontstyle`).on("click", ()=>{
         ...
         $this.find(`.cte-etext`).on("input", function(){
      	obj = canvas.getActiveObject();
         ...
         $this.find(`.cte-efontsize`).on("input", function(){
          obj = canvas.getActiveObject();
        ...
        $this.find(`.cte-echarspacing`).on("input", function(){
          obj = canvas.getActiveObject();
         ...
         $this.find(`.cte-elineheight`).on("input", function(){
          obj = canvas.getActiveObject();
        ...
        $this.find(`.cte-earcx`).on("input", function(){
          obj = canvas.getActiveObject();
        ...
        $this.find(`.cte-earcy`).on("input", function(){
          obj = canvas.getActiveObject();
    ...
    $this.find(`.cte-efilltype`).on("change", function(){
      ...
      $this.find(".cte-ecnormal").on("click", function (){
      	obj = canvas.getActiveObject();
    	     Coloris({
              format: "rgb",
              closeButton: true,
         ...
         $this.find(".cte-ecbgcolor").on("click", function (){
      	obj = canvas.getActiveObject();
    	     Coloris({
              format: "rgb",
              closeButton: true,
        ...
        $this.find(".cte-ecgradientitem").on("change", function(){
             	obj = canvas.getActiveObject();
                 $this.find(".cte-ecgradientoffset").attr({min: (obj.fill.colorStops[Number(this.value)-1].offset)+0.001, max: (obj.fill.colorStops[Number(this.value)+1].offset)-0.001, value: obj.fill.colorStops[Number(this.value)+1].offset, step: 0.001});
                 
         	    render();
                  renderGlobal(obj);
             });
             
       $this.find(`.cte-ecgradientoffset`).on("input", function(){
          obj = canvas.getActiveObject();
        ...
        $this.find(".cte-ecgradientcolor").on("click", function (){
      	obj = canvas.getActiveObject();
       ...
       $this.find(`.cte-ecgx1`).on("input", function(){
          obj = canvas.getActiveObject();
         ...
         $this.find(`.cte-ecgx2`).on("input", function(){
          obj = canvas.getActiveObject();
         ...
         $this.find(`.cte-ecgy1`).on("input", function(){
          obj = canvas.getActiveObject();
         ...
         $this.find(`.cte-ecgy2`).on("input", function(){
          obj = canvas.getActiveObject();
         ...
         $this.find(`.cte-ecgr1`).on("input", function(){
          obj = canvas.getActiveObject();
         ...
         $this.find(`.cte-ecgr2`).on("input", function(){
          obj = canvas.getActiveObject();
    ...
    $this.find(".cte-ecprepeat").on("change", function(){
     ...
     $this.find(`.cte-ecpskew`).attr({min: -2, max: 2, value: 1, step: 0.01}).on("input", function(){
       ...
       $this.find(`.cte-ecpoffsetx`).on("input", function(){
          obj = canvas.getActiveObject();
       ...
       $this.find(`.cte-ecpoffsety`).on("input", function(){
          obj = canvas.getActiveObject();
       ...
       $this.find(".cte-estroke").on("click", function (){
      	obj = canvas.getActiveObject();
    	     Coloris({
              format: "rgb",
              closeButton: true,
       ...
       $this.find(`.cte-estrokewidth`).on("input", function(){
          obj = canvas.getActiveObject();
         ...
         $this.find(".cte-eshadowcolor").on("click", function (){
      	obj = canvas.getActiveObject();
    	     Coloris({
              format: "rgb",
              closeButton: true,
        ...
        $this.find(`.cte-eshadowblur`).on("input", function(){
          obj = canvas.getActiveObject();
         ...
         $this.find(`.cte-eshadowoffsetx`).on("input", function(){
          obj = canvas.getActiveObject();
     ...
     $this.find(`.cte-eshadowoffsety`).on("input", function(){
          obj = canvas.getActiveObject();
        ...
        $this.find(`.cte-eskewx`).on("input", function(){
          obj = canvas.getActiveObject();
...
$this.find(`.cte-efgrayscale`).on("click", ()=>{
      ...
      $this.find(`.cte-efbrightness`).on("click", ()=>{
        ...
        obj.applyFilters();
         ...
         $this.find(`.cte-efvbrightness`).on("input", function(){
          obj = canvas.getActiveObject();
          let isFilter = -1;
          $.each(obj.filters, (i, v)=>{
          	if(v.type.includes("Brightness")){
      ...
      $this.find(`.cte-efcontrast`).on("click", ()=>{
        ...
        obj.applyFilters();
         ...
         $this.find(`.cte-efvcontrast`).on("input", function(){
          obj = canvas.getActiveObject();
          let isFilter = -1;
          $.each(obj.filters, (i, v)=>{
          	if(v.type.includes("Contrast")){
     ...
     $this.find(`.cte-efsaturation`).on("click", ()=>{
        ...
        obj.applyFilters();
         ...
         $this.find(`.cte-efvsaturation`).on("input", function(){
          obj = canvas.getActiveObject();
          let isFilter = -1;
          $.each(obj.filters, (i, v)=>{
          	if(v.type.includes("Saturation")){
        ...
        obj.applyFilters();
         ...
         $this.find(`.cte-efvhue`).on("input", function(){
          obj = canvas.getActiveObject();
          let isFilter = -1;
          $.each(obj.filters, (i, v)=>{
          	if(v.type.includes("HueRotation")){
       ...
       $this.find(`.cte-efblur`).on("click", ()=>{
        ...
        obj.applyFilters();
         ...
         $this.find(`.cte-efvblur`).on("input", function(){
          obj = canvas.getActiveObject();
          let isFilter = -1;
          $.each(obj.filters, (i, v)=>{
          	if(v.type.includes("Blur")){
     ...
     $this.find(`.cte-eopacity`).on("input", function(){
          obj = canvas.getActiveObject();
